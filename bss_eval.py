...
def bss_eval_sources(reference_sources, estimated_sources,
    ...
    if estimated_sources.ndim == 1:
        estimated_sources = estimated_sources[np.newaxis, :] + 0.0000000000001
    if reference_sources.ndim == 1:
        reference_sources = reference_sources[np.newaxis, :] + 0.0000000000001
